        ...
        <div class="row">
            <div class="col-sm-4" >
                <form  ng-submit="changepass()">
                    ...
                    <input type="password" class="form-control" ng-model="puser.new" minlength="8" placeholder="Enter New Password" name="new" required><br>
                    <input type="password" class="form-control"  ng-model="puser.rnew" minlength="8" placeholder="Repeat Password" name="newr" required><br>
        ...
        <div class="row">
            <div class="col-sm-4" >
                <form method="POST" ng-submit="changeemail()">
                    <input type="email" class="form-control"  placeholder="me@example.com" name="uname" ng-model="euser.email" required><br>
        ...
        <div class="row">
            <div class="col-sm-4" >
                <form method="POST" ng-submit="deactivate()">
                    ...
                    <input type="submit" value="Yes" action="drec" class="btn btn-success"/>
                    <input type="button" class="btn btn-danger" value="Back" id="bb2">
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4" >
                <form method="POST" ng-submit="changephone()">
                    <input type="number" class="form-control"  placeholder="phone number with country code eg 91966106XXXX"  ng-model="puser.pno"  minlength="12" required><br>
